/**
 * Default GOV.UK content review system prompt.
 * Extracted here to keep prompt-manager.js within the 500-line file limit.
 */
export const DEFAULT_SYSTEM_PROMPT = `# GOV.UK Content QA Reviewer - Structured Text Output Format
