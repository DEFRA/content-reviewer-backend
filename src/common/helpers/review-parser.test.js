...
const CURRENT_UTILISE = 'CURRENT: utilise'
...
describe('parseBedrockResponse - fallback behaviour', () => {
  ...
  it('does not apply fallback when primary result has content', () => {
    const response = buildMarkerResponse({ scores: SAMPLE_SCORE_LINE })
...
// ============ Hallucinated improvement filtering ============

describe('parseBedrockResponse - hallucinated improvement filtering', () => {
  it('keeps improvement when CURRENT text exists in originalText', () => {
    const originalText = SAMPLE_UTILISE_TEXT
    const improvements = [
      PRIORITY_HIGH_OPEN,
      CATEGORY_PLAIN_ENGLISH,
  ...
  it('drops improvement when CURRENT text is not found in originalText', () => {
    const originalText = 'This document does not contain the word at all.'
    const improvements = [
      PRIORITY_HIGH_OPEN,
      CATEGORY_PLAIN_ENGLISH,
      ISSUE_JARGON_WORD,
  ...
  it('keeps improvement when originalText is empty (no document to check against)', () => {
    const improvements = [
      PRIORITY_HIGH_OPEN,
      CATEGORY_PLAIN_ENGLISH,
      ISSUE_JARGON_WORD,
  ...
  it('drops only the hallucinated improvement when mixed with a real one', () => {
    const originalText = SAMPLE_UTILISE_TEXT
    const improvements = [
      PRIORITY_HIGH_OPEN,
      'REF: 1',
